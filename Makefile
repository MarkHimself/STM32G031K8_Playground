...
_OBJ = main.o startup.o proc_exceptions.o GPIO_Output.o GPIO_Input.o general_timers_pwm.o general_timers_oneshot.o general_timer2_timetracking.o adc.o
OBJ_PATH = obj
...
_DEPS = main.h startup.h proc_exceptions.h GPIO_Output.h GPIO_Input.h general_timers_pwm.h general_timers_oneshot.h general_timer2_timetracking.h adc.h
DEPS_PATH = include
...
$(ODIR)/general_timers_oneshot.o: src/general_timers_oneshot.c $(DEPS)
	$(CC) $(CFLAGS) -o $@ $< -I. $(DEBUG)

$(ODIR)/general_timer2_timetracking.o: src/general_timer2_timetracking.c $(DEPS)
	$(CC) $(CFLAGS) -o $@ $< -I. $(DEBUG)

$(ODIR)/adc.o: src/adc.c $(DEPS)
	$(CC) $(CFLAGS) -o $@ $< -I. $(DEBUG)
